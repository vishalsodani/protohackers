        ...
        if data:
            for b in data:
                ...
                if len(client_data) % 9 == 0:
                    ...
                    timestamp = int.from_bytes(bytearray(client_data[start_index+1: start_index+5]), "big",signed=True)
                    price = int.from_bytes(bytearray(client_data[start_index+5: start_index+9]), "big", signed=True)
